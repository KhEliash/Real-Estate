      ...
      <div className="flex-1 text-left space-y-5">
        ...
        <div className="space-y-3"> 
          ...
          <ol className="ml-3 space-y-3">
            <li className="flex items-center gap-2"><FaDotCircle className="text-green-500"/>{facilities[0]}</li>
            <li className="flex items-center gap-2"><FaDotCircle className="text-green-500"/>{facilities[1]}</li>
            <li className="flex items-center gap-2"><FaDotCircle className="text-green-500"/>{facilities[2]}</li>
